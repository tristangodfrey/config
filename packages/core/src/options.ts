...
import { FigureInstance } from "./figure.js";
import { Config } from "@figure-config/types";

export type ReturnType<O extends Options> = O["returnInstance"] extends true
    ? FigureInstance<MappedConfig<O>>
    : MappedConfig<O>;

export type MappedConfig<O extends Options> =
    O["subSchema"] extends keyof Config ? Config[O["subSchema"]] : Config;
...
export class Options {
    ...
    /**
     * Path to a singular configuration file.
     */
